...
import com.tecgvg.hi.repository.QuestionsRepository;
import com.tecgvg.hi.service.dto.QuestionsDTO;
import com.tecgvg.hi.service.mapper.QuestionsMapper;
...
public class QuestionsService {
    ...
    /**
     *  Get all the questions where AssessmentAnswers is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<QuestionsDTO> findAllWhereAssessmentAnswersIsNull() {
        log.debug("Request to get all questions where AssessmentAnswers is null");
        return StreamSupport
            .stream(questionsRepository.findAll().spliterator(), false)
            .filter(questions -> questions.getAssessmentAnswers() == null)
            .map(questionsMapper::toDto)
