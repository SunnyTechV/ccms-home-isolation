package com.tecgvg.hi.service.criteria;
...
/**
 * Criteria class for the {@link com.tecgvg.hi.domain.QuestionsOptions} entity. This class is used
 * in {@link com.tecgvg.hi.web.rest.QuestionsOptionsResource} to receive all the possible filtering options from
...
public class QuestionsOptionsCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, ansOption, healthCondition, active, lastModified, lastModifiedBy, questionsId, distinct);
    }
